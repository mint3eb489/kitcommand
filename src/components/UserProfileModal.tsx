  ...
  return (
    <div id="profile-modal-backdrop" className="fixed inset-0 bg-black/60 backdrop-blur-md z-[200] flex items-end sm:items-center justify-center p-0 sm:p-4 overflow-y-auto">
      <div 
        ...
        className="bg-white dark:bg-zinc-900 border-t sm:border border-slate-200 dark:border-zinc-800 max-w-md sm:max-w-4xl w-full rounded-t-[2.5rem] sm:rounded-3xl shadow-2xl overflow-hidden flex flex-col sm:my-auto max-h-[92vh] sm:max-h-[85vh]"
      >
        {/* Header styling */}
        ...
        <div className="p-5 overflow-y-auto max-h-[70vh] text-left">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-start">
            
            {/* Linke Spalte (Statistiken & Name) */}
            ...
            {/* Rechte Spalte (Standard-Tab, Perspektive & Design) */}
            <div className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <div id="standard-starttab-container" className="grid grid-cols-2 xs:grid-cols-3 sm:grid-cols-3 md:grid-cols-4 gap-2">
